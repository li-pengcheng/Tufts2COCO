...
def show_bbox_only(coco, anns, show_label_bbox=True, is_filling=True):
    ...
    for ann in anns:
        color = image2color[int(ann['category_id'])]
        ...
        ax.text(
            bbox_x,
            bbox_y,
            '%s' % (coco.loadCats(int(ann['category_id']))[0]['name']),
            color='white',
            bbox=label_bbox)
...
def parse_args():
    ...
    parser.add_argument(
        '--img-dir', default='/home/lipengcheng/Codes/Panoramic/Instance/datasets/dentalX/train2017', help='image folder path')
    parser.add_argument(
        '--ann-file',
        default='/home/lipengcheng/Codes/Panoramic/Instance/datasets/dentalX/annotations/instances_train2017.json',
        help='ann file path')
    parser.add_argument(
